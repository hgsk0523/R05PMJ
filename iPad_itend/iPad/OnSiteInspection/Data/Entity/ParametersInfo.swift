...
struct ParametersInfo {
    ...
    mutating func setParametersInfo(url: URL) throws {
        do {
            ...
            // パラメータ値チェック
            try CustomURLSchemeService.shared.checkParameters(wsheetNO: wsheetNO, uukakuteiDate: uukakuteiDate, katasiki: katasiki, kkName: kkName, meisho: meisho, yoteiYMD: yoteiYMD)
            // 会社CD
